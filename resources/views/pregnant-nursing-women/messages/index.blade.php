...
@section('title')
    Natalpro | Pregnant and Nursing Women | My Inbox
@endsection
...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                ...
                <h2 class="add-ct-btn pull-left"><a href="{{ route('PregNursingOutbox') }}" class="btn btn-rounded btn-sm btn-info waves-effect waves-dark"><i class="mdi mdi-message-plus"></i> Outbox</a></h2>
                                ...
                                <tbody>
                                    ...
                                    @if(count($merge_messages) > 0)
                                        ...
                                        @foreach($merge_messages as $key=>$merge) 
                                            ...
                                            @endif
                                                <td> {{$counter}} </td>
                                                <td><a href="/portal/pregnant-nursing-women/messages/view/{{$encode_message}}">{{ucfirst(substr($subject,0,40))}} ... </a></td>
                                                <td class="max-texts"> <a href="/portal/pregnant-nursing-women/messages/view/{{$encode_message}}"> {{ucfirst(substr($the_message,0,60))}} </a></td>
