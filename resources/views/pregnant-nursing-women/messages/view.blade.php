            ...
            <div class="card-body">
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        var url = "/portal/pregnant-nursing-women/messages/responses/{!!Misc::encoder($the_message->id)!!}"
                ...
                <form class="form-horizontal" id="response_form" method="POST" onsubmit="return false">
                    ...
                    <button type="button" id="response_btn" style="display:none" onclick="return ajaxFormRequest('#response_btn','#response_form','/portal/pregnant-nursing-women/respond','POST','#response_status','Send','no')" class="btn btn-info pull-right"> Send </button>
                    <div style="clear:both"></div>
