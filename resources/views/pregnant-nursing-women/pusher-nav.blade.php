...
<div id="main-wrapper">
    ...
    <script type="text/javascript">
        ...
        var allow_feedback = the_pusher.subscribe('allow_feedback');
        ...
        var patient_send_chat = the_pusher.subscribe('patient_send_chat');
        var patient_receive_chat = the_pusher.subscribe('patient_receive_chat');
        ...
        //for chat with nurses

        patient_send_chat.bind('chat_sent', function (data) {
        ...
        patient_receive_chat.bind('chat_sent', function (data) {
        ...
        launch_chat.bind('launch_chat', function (data) {
            ...
            if(data.patient == patient) {
                window.location = "/portal/pregnant-nursing-women/chats/view/"+data.chat_req;
            }
            
        });

        allow_feedback.bind('allow_feedback', function (data) {
            
            if(data.patient == patient) {
                var details = "req_id="+data.req_id;
                $("#nurse_fullname").html(data.nurse);
                
                if($('#feedbackModal').is(':visible')) {
                    ajaxLoadingRequest('/portal/pregnant-nursing-women/rate-nurse', '#patient_feedback', details, 'POST');
                    return false;
                } else {
        ...
        nurse_rated.bind('nurse_rated', function (data) {
            ...
            if(data.patient == patient) {
                alert('Nurse was successfully rated!');
