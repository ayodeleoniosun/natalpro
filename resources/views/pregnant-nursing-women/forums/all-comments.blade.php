                    ...
                    <li class="reverse" align="left">
                        ...
                        <div style="margin-right:30px">
                            ...
                            <small>
                                ...
                                <a href="#" onclick="return forumRequests('patient','edit-comment','{{$comment->id}}')" class="text-info" style="font-size:14px;color:#fff">Edit</a> &nbsp; &nbsp; 
                                
                                <a href="#" onclick="return forumRequests('patient','delete-comment','{{$comment->id}}')" class="text-danger" style="font-size:14px;color:#fff"> Delete</a>
                            </small>
                        </div>
                    </li>
