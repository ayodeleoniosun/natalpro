        ...
        <div class="card">
            <div class="card-body">
                ...
                @else
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            var url = "/portal/pregnant-nursing-women/forums/comments/{!!Misc::encoder($the_forum->id)!!}"
                ...
                <form class="form-horizontal" id="comment_form" method="POST" onsubmit="return false">
                    ...
                    <button type="button" id="comment_btn" onclick="return ajaxFormRequest('#comment_btn','#comment_form','/portal/pregnant-nursing-women/comment','POST','#comment_status','Comment','no')" class="btn btn-info pull-right"> Comment</button>
                    <div style="clear:both"></div>
