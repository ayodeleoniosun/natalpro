                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($outbox as $key=>$message) 
                                            ...
                                            <tr>
                                                <td> {{$counter}} </td>
                                                <td><a href="/portal/natal-nurse/messages/view/{{$encode_message}}">{{ucfirst(substr($message->subject,0,40))}} ... </a></td>
                                                <td class="max-texts"> <a href="/portal/natal-nurse/messages/view/{{$encode_message}}"> {{ucfirst(substr($message->message,0,60))}} </a></td>
