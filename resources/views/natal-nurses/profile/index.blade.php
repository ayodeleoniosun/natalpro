...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <h2 class="add-ct-btn pull-right"><a href="{{ route('NatalNurseEditProfile') }}" class="btn btn-rounded btn-sm btn-info waves-effect waves-dark"><i class="fa fa-pencil"></i> Edit Profile</a></h2>
                    ...
                    <form class="form-horizontal form-material" id="update_pix_form" method="POST" onsubmit="return false" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer" style="border:0px">
                            ...
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                             <button type="button" id="update_pix_btn" onclick="return ajaxFormRequest('#update_pix_btn','#update_pix_form','/portal/natal-nurse/update-pix','POST','#update_pix_status','Change','yes')" class="btn btn-info"><i class="fa fa-check"></i> Change </button>
                        </div>
                    </form>
                </div>    
            </div>
