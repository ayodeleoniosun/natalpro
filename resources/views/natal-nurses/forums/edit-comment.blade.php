            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-comment-form" method="POST" onsubmit="return false">
                    ...
                    <div class="modal-footer" style="border:0px">
                        ...
                        <button type="button" id="update-comment-btn" onclick="return ajaxFormRequest('#update-comment-btn','#update-comment-form','/portal/natal-nurse/forum-requests/operation/nurse-update-comment','POST','#update-comment-status','Save changes','no')" class="btn btn-info">Save changes </button>
                    </div>
