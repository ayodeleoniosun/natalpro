            ...
            <div class="card-body">
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        var url = "/portal/controlling-room-admin/messages/responses/{!!Misc::encoder($the_message->id)!!}"
                ...
                <form class="form-horizontal" id="response_form" method="POST" onsubmit="return false">
                    ...
                    <input type="hidden" name="recipient" value="{!! Misc::encoder($the_message->sender) !!}"/>
                    
                    <div class="form-group">
                        <textarea name="message" id="pm_message" class="form-control" rows="7" placeholder="Type your response below"></textarea>
                    </div>

                    <button type="button" id="response_btn" style="display:none" onclick="return ajaxFormRequest('#response_btn','#response_form','/portal/controlling-room-admin/respond','POST','#response_status','Send','no')" class="btn btn-info pull-right"> Send </button>
                    <div style="clear:both"></div>
