...
<div id="main-wrapper">
    ...
    <header class="topbar" style="background-color:#31516E">
                ...
                <ul id="sidebarnav">
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-user-circle"></i><span class="hide-menu">Users </span></a>
                        <ul aria-expanded="false" class="collapse">
                            ...
                            <li><a href="{{ route('NatalNurses') }}">Natal Nurses</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-medical-bag"></i><span class="hide-menu">Requests </span></a>
                        <ul aria-expanded="false" class="collapse">
                            ...
                            <li><a href="{{ route('NurseRequests') }}">Home Service Nurses</a></li>
                        </ul>
                    </li>
    ...
    <script type="text/javascript">
        ...
        var admin_private_chat = the_pusher.subscribe('admin_private_chat');
        var admin_receive_private_chat = the_pusher.subscribe('admin_receive_private_chat');
        
        admin_private_chat.bind('admin_private_chat', function (data) {
        ...
        admin_receive_private_chat.bind('admin_private_chat', function (data) {
