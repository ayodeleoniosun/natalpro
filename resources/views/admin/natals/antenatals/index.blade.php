...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <h2 class="add-ct-btn pull-right"><button type="button" class="btn btn-rounded btn-sm btn-info waves-effect waves-dark" data-toggle="modal" data-target="#antenatalFormModal" data-whatever="@mdo"><i class="mdi mdi-upload"></i> Upload new antenatal</button></h2>
                    
            <div style="clear:both;"></div>
            <br/>

            <div class="modal fade" id="antenatalFormModal" tabindex="-1" role="dialog" aria-labelledby="antenatalFormModalLabel1">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addDeptAdminModalLabel1">Upload New Antenatal</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal" id="antenatal_form" method="POST" onsubmit="return false" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="modal-footer" style="border:0px">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                     <button type="submit" id="antenatal_btn" onclick="return ajaxFormRequest('#antenatal_btn','#antenatal_form','/portal/controlling-room-admin/upload-antenatal','POST','#antenatal_status','Upload','yes')" class="btn btn-info">Upload </button>
                                </div>
                                <div style="clear:both"></div>
                                <br/>
                                <div id="antenatal_status" align="center"></div>
                        ...
                        <div class="tab-pane active" id="videos" role="tabpanel">
                            ...
                            @else
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div style="margin:0 auto" align="center"> {{$categories->links()}} </div>
                                    </div>
                                </div>
                            @endif
