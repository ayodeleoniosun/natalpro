...
<script type="text/javascript">
    $(document).ready(function() {
        $('#editVacSampleFormModal{{$vac_interval}}').modal('show');
        ...
        $("#translate_update_btn").click(function() {
            ...
            let message = $("#update_sample_english_message").val();
            let data = "message="+message;
            let translate = ajaxLoadingRequest('/portal/controlling-room-admin/translate-vaccination', '#update-translate-status', data, 'POST');
        });
    });
</script>


<div class="modal fade" id="editVacSampleFormModal{{$vac_interval}}" tabindex="-1" role="dialog" aria-labelledby="vaccinationSampleFormModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{$the_interval}} vaccination SMS sample form</h4>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update_sms_sample_form" method="POST" onsubmit="return false">
                    ...
                    <input type="hidden" name="interval" value="{{$vac_interval}}"/>
